...
INSERT INTO `userlist` (`user`, `pw`, `role`) VALUES ('admin', '7e0e1d95c8e754fa19d4032d71984549582bde1d0d042765bf4058b3581bb71b', 'admin');
COMMIT;
...
--
ALTER TABLE `dir` MODIFY `no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;

--
-- テーブルの AUTO_INCREMENT `overview`
--
ALTER TABLE `overview` MODIFY `no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;

--
-- テーブルの AUTO_INCREMENT `time`
--
ALTER TABLE `time` MODIFY `no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
COMMIT;